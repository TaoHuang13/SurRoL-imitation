...
#     num_itr = 100 if not args.video else 100
#     cnt = 0
...
#         one_video_folder = os.path.join(folder, str(cnt)) 
#         os.mkdir(one_video_folder)
#         one_video_folder = os.path.join(folder, str(cnt)) + '/'
        
#         if args.video:
#             # video_name = "video_"
#             # video_name += args.env + "-v" + str(cnt) + ".mp4"
...
#                 imageio.imwrite(one_video_folder + '%d.png' % i, img)
